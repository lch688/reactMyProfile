...
import img from '../../../../assets/imgs/Bachelor_Art.jpg'
import img1 from '../../../../assets/imgs/GBC_Transcript1.jpg'
import img2 from '../../../../assets/imgs/GBC_Transcript2 .jpg'
import img3 from '../../../../assets/imgs/GBC_Diploma.jpg'
...
export const Certification:React.FC<props> =() =>{
    ...
    const first=useSelector(state => state.Background.first)
    const second=useSelector(state => state.Background.second)
    const third=useSelector(state => state.Background.third)
